...
function Postup() {
 ...
 function getCurrentDate(separator=''){
  ...
  axios.get("http://localhost:3001/posts/byuserId/1").then((response)=>{
...
borderBlockStartColor:'lightblue',borderWidth:'0.4rem'};
    ...
    <div>
      <Row>
          ...
          <Col style={{paddingTop:'1rem',paddingLeft:'1px'}}>
            ...
            fontSize:'35px',color:'black',fontWeight:'bolder'}}>{getCurrentDate(':')}</div><br/>
 ...
 { !paginatedPosts ? ('Nodata'):(
  ...
  <Col style={{paddingTop:'1rem',paddingLeft:'1px'}}>
            ...
            <div >
              <a href='https://twitter.com/ONGC_'><img src={right} width='300px' height='200px'
              style={{borderRadius:'2rem'}}
              />
